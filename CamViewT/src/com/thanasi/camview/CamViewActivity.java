...
public class CamViewActivity extends Activity implements CvCameraViewListener2 {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mOpenCvCameraView = (CameraBridgeViewBase) findViewById(R.id.CamView_JCV);
    ...
    public Mat onCameraFrame(CvCameraViewFrame inputFrame) {
        ...
        switch (CamViewActivity.viewMode) {
        case CamViewActivity.VIEW_MODE_RGBA:
            break;

        case CamViewActivity.VIEW_MODE_HIST:
        ...
        case CamViewActivity.VIEW_MODE_CANNY:
        ...
        case CamViewActivity.VIEW_MODE_SOBEL:
        ...
        case CamViewActivity.VIEW_MODE_SEPIA:
        ...
        case CamViewActivity.VIEW_MODE_ZOOM:
        ...
        case CamViewActivity.VIEW_MODE_PIXELIZE:
            if ((mRgbaInnerWindow == null) || (mRgba.cols() != mSizeRgba.width) || (mRgba.height() != mSizeRgba.height))
                CreateAuxiliaryMats();
        ...
        case CamViewActivity.VIEW_MODE_POSTERIZE:
            if ((mRgbaInnerWindow == null) || (mRgba.cols() != mSizeRgba.width) || (mRgba.height() != mSizeRgba.height))
                CreateAuxiliaryMats();
            /*
